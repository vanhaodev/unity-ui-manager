...
namespace vanhaodev.uimanager.samples.kpopshop.animation
{
    ...
    public class ButtonScaleAnimation : ButtonAnimationBase
    {
        ...
        public override void OnPointerEnter(GameObject target)
        {
            ...
            _rect.DOKill();
            _rect.DOScale(_hoverScale, _duration).SetLink(gameObject);
        }
        ...
        public override void OnPointerExit(GameObject target)
        {
            ...
            _rect.DOKill();
            _rect.DOScale(1f, _duration).SetLink(gameObject);
        }
        ...
        public override void OnPointerDown(GameObject target)
        {
            ...
            _rect.DOKill();
            _rect.DOScale(_pressedScale, _duration * 0.8f).SetLink(gameObject);
        }
        ...
        {
            base.OnClick(target);
            _rect.DOPunchScale(Vector3.one * 0.1f, 0.2f).SetLink(gameObject);
        }
    }
}