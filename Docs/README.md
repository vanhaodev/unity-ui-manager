...
<pre><code><strong>https://github.com/vanhaodev/unity-ui-manager.git?path=Exported/com.vanhaodev.uimanager#1.0.7
</strong></code></pre>
{% endtab %}
...
```json
"com.vanhaodev.uimanager": "https://github.com/vanhaodev/unity-ui-manager.git?path=Exported/com.vanhaodev.uimanager#1.0.7"
```
{% endtab %}
{% endtabs %}
{% endstep %}
